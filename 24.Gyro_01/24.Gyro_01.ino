...
const int MPU = 0x68; // 자이로센서 I2C통신 주소 저장

/*
int16_t = 16비트 정수형 값만 저장 가능한 변수
AcX, AcY, AcZ = x,y,z축의 가속도
Tmp = 센서 내부 온도(센서 온도에 따라 오차가 달라지기 때문)
GyX, GyY, GyZ = x,y,z축의 자이로스코프 값
*/
int16_t AcX, AcY, AcZ, Tmp, GyX, GyY, GyZ;

void setup() {
  Serial.begin(9600);
  Wire.begin(); // 아두이노 I2C 통신 활성화
...
void loop() {
  ...
  // 데이터 읽어오기
  // requestFrom의 매개변수 : (0x68이라는 주소를 가진 I2C통신을 하는 장치에, 14바이트를 읽어, 다 읽었으면 통신 종료)
